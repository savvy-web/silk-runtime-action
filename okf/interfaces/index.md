...
* [Turbo worker environment — the main-to-worker handoff contract](turbo-worker-environment.md) - The TURBOGHA_* environment variables the detached turbo cache server reads, and how they are assembled and consumed.
