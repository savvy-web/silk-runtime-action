...
* [Cross-phase state — STATE\_KEYS and the four Schema.Class bundles](cross-phase-state.md) - What main writes and post reads across the GitHub Actions main/post process boundary, and what breaks when an entry's shape is wrong.
